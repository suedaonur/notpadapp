...
namespace NotDefteri
{
    public partial class Form1 : Form
    {
        ...
        private void LoadListView()
        {
            ...
            // NotServices örneðinizi daha önce oluþturmuþtunuz:
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                // Eðer ayný baþlýk zaten varsa servis bir Exception fýrlatacak
                notService.YeniNotOlustur(not, kategoriName);

                // Baþarýlýysa listeyi yenile ve kullanýcýya bilgi ver
                LoadListView();
            ...
            {
                // Duplicate header veya baþka bir hata
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                // Kategori bulunamadýðýnda veya baþka bir hatada uyarý ver
                MessageBox.Show(
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            // Seçilen ilk öðeyi al
            var item = listView1.SelectedItems[0];
            var kategoriName = item.Text;                  // 1. sütun = kategori
            var notHeader = item.SubItems[1].Text;       // 2. sütun = baþlýk
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // Silme + yeniden ekleme yerine doðrudan güncelleme
